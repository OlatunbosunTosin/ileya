from mbti_personality_function import *

name = input("What is your name? ")

answers = response_collection()
personality_type = ""

print(f"Hello {name} You selected")
print()    

extroverted_vs_introverted = extroverted_introverted_personality(answers)
sensing_vs_intuitive = sensing_vs_intuitive_personality(answers)
thinking_vs_feeling = thinking_vs_feeling_personality(answers)
judging_vs_perceptive = judging_vs_perceptive_personality(answers)

for count in range(5):
    print(extroverted_vs_introverted[0][count])
    
print(f"Number of A: {extroverted_vs_introverted[1]}")
print(f"Number of B: {extroverted_vs_introverted[2]}")
print()

if extroverted_vs_introverted[1] > extroverted_vs_introverted[2]:
    personality_type += "E"
else:
    personality_type += "I"
...
for count in range(5):
    print(sensing_vs_intuitive[0][count])
    
print(f"Number of A: {sensing_vs_intuitive[1]}")
print(f"Number of B: {sensing_vs_intuitive[2]}")
print()

if sensing_vs_intuitive[1] > sensing_vs_intuitive[2]:
    personality_type += "S"
else:
    personality_type += "N"
...
for count in range(5):
    print(thinking_vs_feeling[0][count])
    
print(f"Number of A: {thinking_vs_feeling[1]}")
print(f"Number of B: {thinking_vs_feeling[2]}")
print()

if thinking_vs_feeling[1] > thinking_vs_feeling[2]:
    personality_type += "T" 
else:
    personality_type += "F"
...
for count in range(5):
    print(judging_vs_perceptive[0][count])
    
print(f"Number of A: {judging_vs_perceptive[1]}")
print(f"Number of B: {judging_vs_perceptive[2]}")
print()

if judging_vs_perceptive[1] > judging_vs_perceptive[2]:
    personality_type += "J"
else:
    personality_type += "P"
